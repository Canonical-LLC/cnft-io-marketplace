...
$baseDir/core/collect-1-tx.sh \
  ...
  $tempDir/$BLOCKCHAIN_PREFIX/datums/$DATUM_PREFIX/reserve-not-met-bid-1.json \
  $(cat $tempDir/$BLOCKCHAIN_PREFIX/datums/$DATUM_PREFIX/reserve-not-met-bid-1-hash.txt) \
